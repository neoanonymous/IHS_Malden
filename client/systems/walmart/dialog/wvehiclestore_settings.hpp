...
// ******************************************************************************************
#include "wvehiclestoreDefines.hpp"
...
class wvehshopd
{
	...
	class Controls
	{
		...
		class BuyVehicle: w_RscButton
		{
			...
			action = "[0] execVM 'client\systems\walmart\buyVehicles.sqf'";
			text = "Buy";
		...
		*/
		...
		{
			idc = -1;
			action = "closeDialog 0; [0] execVM 'client\systems\walmart\loadgunStore.sqf';";
			text = "Gun Store";
		...
		{
			idc = -1;
			action = "closeDialog 0; [0] execVM 'client\systems\walmart\loadGenStore.sqf';";
			text = "General Store";
			sizeEx = GunStoreButton_textSize;

			x = GunStoreMainBG_X + (0.25 * SZ_SCALE);
			y = GunStoreMainBG_Y + (-0.05 * SZ_SCALE);
			w = 0.235 * SZ_SCALE;
			h = 0.045 * SZ_SCALE;
		};
		...
		class VikStoreOpen: w_RscButton
		{
			...
			x = GunStoreMainBG_X + (0.5 * SZ_SCALE);
			y = GunStoreMainBG_Y + (-0.05 * SZ_SCALE);
			w = 0.235 * SZ_SCALE;
			h = 0.045 * SZ_SCALE;
		};
