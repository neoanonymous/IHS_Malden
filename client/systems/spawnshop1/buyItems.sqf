...
storePurchaseHandle = _this spawn
{
	...
	if (isNil "_price") then
	{
		...
		} forEach [ssgenItemArray, ssfaceWearArray];
	};
	...
	if (isNil "_price") then
	{
		...
		} forEach (call ggcustomPlayerItems);
	};
