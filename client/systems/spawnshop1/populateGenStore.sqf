...
switch(_switch) do
{
	case 0:
	{
		_itemsArray = call ssheadArray;
	};
	case 1:
	{
		_itemsArray = call ssuniformArray;
	};
	case 2:
	{
		_itemsArray = call ssvestArray;
	};
	case 3:
	{
		_itemsArray = call ssbackpackArray;
	};
	case 4:
	{
		_itemsArray = call ssgenItemArray;
	};
	case 5:
	{
		_itemsArray = call ssfaceWearArray;
	};	
	case 6:
	{
		_itemsArray = call sscustomPlayerItems;
