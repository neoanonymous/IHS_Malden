...
class vehshopdP
{
	...
	onLoad = "[[0], populateVehicleStoreP] execFSM 'call.fsm'";
	...
	class Controls
	{
		...
		class ColorList: w_RscList
		{
			...
			onLBSelChanged = "[] execVM 'client\systems\PvehicleStore\colorInfo.sqf'";
			font = "RobotoCondensed";
			sizeEx = 0.034 * TEXT_SCALE;
		...
		{
			idc = -1;
			action = "[0] execVM 'client\systems\PvehicleStore\buyVehicles.sqf'";
			text = "Buy";
		...
		{
			idc = vehshop_button0;
			action = "[0] call populateVehicleStoreP";
			text = "Land";
			sizeEx = VehStoreButton_textSize;
		...
		{
			idc = vehshop_button1;
			action = "[1] call populateVehicleStoreP";
			text = "Armored";
			sizeEx = VehStoreButton_textSize;
		...
		{
			idc = vehshop_button2;
			action = "[2] call populateVehicleStoreP";
			text = "Tanks";
			sizeEx = VehStoreButton_textSize;
		...
		{
			idc = vehshop_button3;
			action = "[3] call populateVehicleStoreP";
			text = "Helicopters";
			sizeEx = VehStoreButton_textSize;
		...
		class StoreButton4: w_RscButton
		{
			...
			x = VehStoreMainBG_X + (0.0167 * SZ_SCALE);
			y = VehStoreMainBG_Y + (0.245 * SZ_SCALE);
			w = 0.1173 * SZ_SCALE;
			h = 0.020 * SZ_SCALE;
		};
		...
		class StoreButton6: w_RscButton
		{
			...
			x = VehStoreMainBG_X + (0.0167 * SZ_SCALE);
			y = VehStoreMainBG_Y + (0.295 * SZ_SCALE);
			w = 0.1173 * SZ_SCALE;
			h = 0.020 * SZ_SCALE;
		};
		...
		{
			idc = vehshop_button5;
			action = "[7] call populateVehicleStoreP";
			text = "Boats";
			sizeEx = VehStoreButton_textSize;
