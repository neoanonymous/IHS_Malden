...
storePurchaseHandle = _this spawn
{
	...
	_dialog = findDisplay vehshop_DIALOGP;
	...
	{
	playSound3D [call currMissionDir + "client\sounds\GetToTheChopper.ogg", vehicle player, false, getPosASL player, 10, 1, 50];
	}
	else
	{
	playSound3D [call currMissionDir + "client\sounds\ZoomZoom.ogg", vehicle player, false, getPosASL player, 2.5, 1, 50];
	};*/
};
