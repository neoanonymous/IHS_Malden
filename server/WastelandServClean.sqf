...
#define MONEY_CLEANUP_TIME (600*60) // Dropped money cleanup time
...
#define DEBRIS_CLEANUP_TIME (60) // Vehicle crash crater/debris cleanup time (actual vehicle wreck cleanup is handled through description.ext parameters)
...
_storeNPCs = allUnits select {[["GenStore","GunStore","VehStore","WalMart1","WalMart2","spawnshop1","spawnshop2"], vehicleVarName _x] call fn_startsWith};
_baseClass = "";
