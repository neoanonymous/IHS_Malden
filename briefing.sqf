...
[
"Hackers Mission Glitch",
"
<br/>Hackers Mission Glitch:
<br/>The use of a drone to complete the hackers mission is strictly prohibited. Any attempt to do so will result in a permanent ban from our server.
"
]];
...
"
<br/>Cheating:
<br/>Cheating/Hacking is strictly prohibited. No warning or dialog will be initiated from our admins. You will simply be permanently banned. There is also no way of repealing the ban without you being able to prove otherwise.
"
]];
...
"
<br/>Team Killers:
<br/>Team killing is not allowed. If you're being intentionally team killed, please report it to an admin as soon as possible. Please do not retaliate by team killing the other player back, doing so will result in your punishment as well.
<br/>
<br/>(Coming Soon):  We're currently coding a system to detect and automatically punish team killers, forcing them to the Independent team. Our team ban lengths will be as followed:
<br/>
<br/>*First Offense: 30 minutes 
<br/>*Second Offense: 1 Day
<br/>*Third offense: 1 Week
<br/>*Fourth offense: Permanent ban from Blufor & Opfor, you'll only be able to play on Independent.
"
]];
...
"
<br/>Ghosting:
<br/>Ghosting is strictly prohibited on our servers. Ghosting is when you're communicating with a player on another team and are being told player locations and specific details to gain an unfair advantage against your enemies. Doing so will result in both parties receiving a ban. The length of the ban is at the discretion of the admin issuing the ban depending upon severity.
"
]];

player createDiaryRecord ["Rules",
[
"No Team peeking/team switching",
"
<br/>Team peeking/team switching:
<br/>Team peeking is defined as: Changing teams from Blufor or Opfor to seek out a players whereabouts, disconnecting, going to Independent, killing them, then coming back to repeat the same steps.
<br/>
<br/>In addition to this, if you connect to Blufor or Opfor to get on the server, get your gear while you are on the map instead of spawn room, then switch to Independent while still in the world map instead of just spawn room, this will be seen as team peeking/team switching.
<br/>
<br/>*First Offense: 1 Day
<br/>*Second Offense: 1 Week
<br/>*Third offense: Permanent ban
...
"Please Note",
"
Any actual punishments may be more or less severe, depending on the surrounding circumstances and subject to staff's discretion.
All bans  for the A3 Servers will be in the Bans section, if you wish to repeal a ban, you must go to your ban posting and prove you are innocent in a public manner on the forums.
"
]];
