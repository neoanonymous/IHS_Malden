...
class RscListbox_1500: w_RscListbox
{
	idc = 1500;
...
{
	idc = 1600;
	action = "[ctrlText 1400] call pAx_fnc_plsSave;";
...
{
	idc = 1601;
	action = "[lbCurSel 1500] call pAx_fnc_plsLoad;";
...
{
	idc = 1602;
	action = "[lbCurSel 1500] call pAx_fnc_plsDelete;";
