...
_filesizeamountrandomizer = [206340,251350,312248,387967,415923];
	...
	{
		{
			...
			player setVariable ["cmoney", (player getVariable ["cmoney", 0]) + 500000, true];
			[] spawn fn_savePlayerData;
			systemChat format["You have hacked players bank accounts to the value of $500,000"];
				};
			};
